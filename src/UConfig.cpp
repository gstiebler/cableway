...
//
//  // Pega o registro de configura��o de instrumento e transforma o seu valor numa lista.
...
int CConfig::NumReg()
{
  // Retorna o n�mero de registros de configura��o
...
//  while (true)
//  {
//    // Encontra a primeira ocorr�ncia de '/' na Lista de valores..
//    pos=ListaValores.find("/");
//
//    // Se não for encontrado '/', então p�ra
//    if (pos==string::npos)
//      break;
//
...
//
//    // Bota tudo em mai�sculo
//    transform(temp.begin(), temp.end(), temp.begin(), toupper);
//
//    // E guarda no fim da lista
//    lista->push_back(temp);
//
//    // Da� coloca a lista sem o primeiro nome e a '/'
...
//  else
//  {
//    // S� chega aqui se tiver um problema no formato em que foi escrito na configura��o
//    int x = 5;//ShowMessage("Por favor, verifique a sua configura��o de n�veis.");
//  }
}
//---------------------------------------------------------------------------
